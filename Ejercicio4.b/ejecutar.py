...
def output():
    ...
    df = spark.sql("select kword, sum(total) as suma from ejercicio4b  where times between cast('2018-12-07 12:00:00' as timestamp)- INTERVAL 1 HOUR and cast('2018-12-07 12:00:00' as timestamp) group by kword  order by suma desc limit 15")
    df.show()
